...
最終更新: 2026-01-31（複数パターン組み合わせシリーズ追加）

## デザインパターン学習シリーズ

GoFの23パターンのうち、20パターンをカバー済（アルファベット順）。

> [!NOTE]
> Chain of Responsibilityパターン、Proxyパターン、Observerパターンには2つのシリーズがあります（異なる題材で差別化）。

| パターン名 | シリーズタイトル | 回数 | 連載構造案 | 目次記事 |
|-----------|----------------|------|------------|---------|
| Abstract Factory | Perlで作る注文フローの国別キット | 全8回 | abstract-factory-pattern-series-structure.md | [目次](/2026/01/25/001050/) |
| Adapter | 天気情報ツールで覚えるPerl | 全7回 | adapter-pattern-series-structure.md | [目次](/2026/01/07/223826/) |
| Bridge | PerlとMooで作るランダムダンジョンジェネレーター | 全7回 | bridge-pattern-series-structure.md | [目次](/2026/01/26/002239/) |
...
| Interpreter | PerlとMooでダイス言語を作ってみよう | 全8回 | interpreter-pattern-series-structure.md | [目次](/2026/01/29/000330/) |
| Mediator | PerlとMooで航空管制シミュレーターを作ろう | 全8回 | mediator-pattern-series-structure.md | [目次](/2026/01/30/001109/) |
...
| Observer | Perlでハニーポット侵入レーダーを作ろう | 全10回 | observer-pattern-series-structure-2026.md | [目次](/2026/01/18/061505/) |
| Prototype | PerlとMooでモンスター軍団を量産してみよう | 全6回 | prototype-pattern-series-structure.md | [目次](/2026/01/17/004454/) |
| Proxy | Perlで作るブルートフォース攻撃シミュレータ | 全5回 | cracker-tool-series-structure.md | [目次](/2026/01/14/004249/) |
| Proxy | Mooで作るゴーストギャラリー・ビューワ | 全5回 | proxy-pattern-series-structure.md | [目次](/2026/01/17/231118/) |
| Singleton | 設定ファイルマネージャーを作ってみよう | 全8回 | singleton-pattern-series-structure.md | [目次](/2026/01/08/033715/) |
| State | Mooを使って自動販売機シミュレーターを作ってみよう | 全10回 | state-pattern-series-structure.md | [目次](/2026/01/10/001853/) |
...
| Visitor | PerlとMooでドキュメント変換ツールを作ってみよう | 全8回 | visitor-pattern-series-structure.md | [目次](/2026/01/27/005724/) |
...
| テーマ | シリーズタイトル | 回数 | 使用パターン | 連載構造案 | 目次記事 |
|-------|----------------|------|-------------|------------|---------|
| RPG戦闘 | PerlとMooでテキストRPG戦闘エンジンを作ろう | 全10回 | State+Command+Strategy+Observer | multi-pattern-series-structure.md | [目次](/2026/01/31/001956/) |
| テキスト処理 | Perl/Mooでテキスト処理パイプライン | 全6回 | Chain of Responsibility+Decorator | multi-pattern-series-structure-2.md | [目次](/2026/01/30/002333/) |
| バックアップ | Perlで作るファイルバックアップツール | 全8回 | Template Method+Strategy | backup-tool-series-structure.md | [目次](/2026/01/30/003407/) |

---

## 実践アプリケーション開発シリーズ

| カテゴリ | シリーズタイトル | 回数 | 連載構造案 | 目次記事 |
|---------|----------------|------|------------|---------|
