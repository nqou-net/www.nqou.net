...
> [!NOTE]
> Proxyパターンには2つのシリーズがあります（異なる題材で差別化）。
> Chain of Responsibilityパターンには2つのシリーズがあります（ユーザー登録バリデーション、決済審査システム）。
...
> [!NOTE]
> Chain of Responsibilityパターンは2シリーズありますが、合計シリーズ数は重複カウントしていません。
