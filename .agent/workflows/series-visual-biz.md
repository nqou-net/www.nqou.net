---
description: "連載構造案から統合記事を作成する汎用ワークフロー（Phase 5: 挿絵生成 - Business）"
---

# Phase 5: 挿絵生成（Business）
...
```
Corporate memphis style, flat design, confidence blue and grey, professional vector art, clean composition, no text
```
...
[スタイル定型文]: Step 1で決めたスタイル定義（例：Corporate memphis style...）
...
// ツールの呼び出し例
generate_image({
  Prompt: "A friendly robot butler in corporate memphis style, flat design, holding a tablet. Blue and grey palette, professional look. No text in the image.",
