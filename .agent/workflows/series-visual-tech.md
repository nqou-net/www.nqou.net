---
description: "連載構造案から統合記事を作成する汎用ワークフロー（Phase 5: 挿絵生成 - Tech/Modern）"
---

# Phase 5: 挿絵生成（Tech/Modern）
...
// ツールの呼び出し例
generate_image({
  Prompt: "A friendly robot butler in flat vector style, isometric view, holding a digital tablet. Cool blue and cyan palette, clean background. No text in the image.",
