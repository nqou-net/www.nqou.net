...
5. 各記事の執筆
   - 連載構造に基づいて、各単体記事を順番に作成する
   - 各単体記事については「単体記事のワークフロー」の**アウトライン作成**、**原稿作成**、**挿絵を追加する**、を実行する
...
## シリーズ記事（連載記事）のレビュー（公開前に実施）

1. シリーズ記事の公開日時を決定する
  - フロントマターの`iso8601`を日本時間で指定する
  - 第1回は、レビュー実施時間の24時間後とする
  - 第2回以降は、前回（第2回の場合は第1回）の1時間後とする
...
6. シリーズ記事を公開する
  - 最終チェックに問題がなければ、シリーズ記事（目次記事含む）のフロントマターの`draft`を`false`に変更する
