...
$info_mail = qq((C)1999 - 2000 [$info_mailName](mailto:$info_mailAddr). All rights reserved.);

$info_copyright = "<address>\n<font face=times>$info_uri
\n$info_mail</font>
\n</address>\n";
...
#   require "dumpvar.pl";   dumpValue(%usr_links);
    print "Jcode $Jcode::VERSION
\n";

    $japanese = "日本語に変換する文字列。
\n";
    print useJcode($japanese);

    print Jcode->new('これも日本語
')->jis;
...
\n";
    ...
    print "jcode.pl $jcode::version
\n";

    print usejcode($japanese);

    print jcode::convert('これも日本語
', $usr_outcode);
