...
n";
    ...
    Jprint('&hoge::hogeprint;で呼び出し
');
    &hoge::hogeprint;
    Jprint('&hoge::hogeprint();で呼び出し
');
    &hoge::hogeprint();
    Jprint('&hoge::hogeprint($_);で呼び出し
');
    &hoge::hogeprint($_);
    print "
n";

    Jprint('&hoge::hogeprint;で配列呼び出し
');
    foreach(@_){
        &hoge::hogeprint;
    }
...
n";
    ...
    Jprint('&hoge::hogeprint($_);で配列呼び出し
');
    foreach(@_){
        &hoge::hogeprint($_);
    }
...
n";
    ...
    Jprint('Jprint(hoge::hogereturn);で呼び出し（不可。文字列と解釈される）
');
    Jprint(hoge::hogereturn);
    print "
n";

    Jprint('Jprint(hoge::hogereturn());で呼び出し
');
    Jprint(hoge::hogereturn());
    Jprint('Jprint(hoge::hogereturn($_));で呼び出し
');
