...
subtest 'Greetable role functionality' => sub {
    ...
    is $obj->greet, "Hello, I'm Test User", 'greet returns correct message';
};
...
subtest 'Greetable role all methods' => sub {
    ...
    is $greeter->greet, "Hello, I'm Alice", 
