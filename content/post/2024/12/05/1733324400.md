---
title: "Perl正規表現マスター - パターンマッチングの深淵なる世界"
description: "Perl正規表現の基本から応用まで体系的に解説。実践的なパターンと活用方法を紹介し、Perlならではの正規表現機能を深く理解する"
date: 2024-12-05T00:00:00+09:00
tags: ["Perl", "正規表現", "regex", "パターンマッチング"]
draft: true
---
...
# 名前付きキャプチャを使った置換
my $log = "Error at 2024-12-05 10:30:00";
$log =~ s/(?<y>\d{4})-(?<m>\d{2})-(?<d>\d{2})/$+{y}\/$+{m}\/$+{d}/;
say $log;  # "Error at 2024/12/05 10:30:00"
```
...
my @dates = ('2024-12-05', '12/05/2024', 'invalid');
...
my $log = <<'LOG';
2024-12-05 10:30:15 [INFO] Application started
2024-12-05 10:30:22 [ERROR] Connection failed: timeout
2024-12-05 10:31:05 [WARN] Retrying connection
2024-12-05 10:31:10 [INFO] Connected successfully
LOG
