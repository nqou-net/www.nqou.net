...
# ISO 8601 形式の文字列から作成
my $from_string = Time::Moment->from_string('2024-12-12T15:30:45Z');
```
...
# 2024-12-12T15:30:45Z

# strftime 形式
print $moment->strftime('%Y年%m月%d日 %H:%M:%S'), "\n";
# 2024年12月12日 15:30:45
...
# 日付操作の比較
my $dt = DateTime->new(year => 2024, month => 12, day => 12);
my $tm = Time::Moment->new(year => 2024, month => 12, day => 12);
...
# ログファイルから時刻を抽出して集計
my @log_lines = (
    '2024-12-12T10:15:30Z INFO: User login',
    '2024-12-12T10:16:45Z ERROR: Connection failed',
    '2024-12-12T10:17:20Z INFO: User logout',
    '2024-12-12T11:30:15Z INFO: User login',
);
...
# 2つの日時が同じかチェック
my $same = Time::Moment->new(year => 2024, month => 12, day => 1);
if ($start == $same) {
    say "同じ日時です";
}
```
