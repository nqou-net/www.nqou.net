...
description: Perl Advent Calendar 2024がスタート！AIを活用した新しい試みで、25日間Perlの魅力を再発見する企画です
draft: true
hidden: false
image: /favicon.png
iso8601: 2024-12-01T00:00:00+09:00
license: ~
math: ~
tags:
  - perl
  ...
  - ai
  - community
title: Perl Advent Calendar 2024 へようこそ！ - AIとPerlの新しい挑戦

---

## Perl Advent Calendar 2024 へようこそ！

[@nqounet](https://x.com/nqounet)です。

12月1日、いよいよ Perl Advent Calendar 2024 が始まります！この25日間、毎日Perlに関する記事をお届けしていく予定です。初日となる今日は、この企画の趣旨と今後の予定についてお話しします。

## アドベントカレンダーとは

アドベントカレンダー（Advent Calendar）は、もともとクリスマスまでの日数を数えるためのカレンダーです。IT業界では、12月1日から25日まで、毎日異なる著者が特定のテーマについて記事を公開していく企画として定着しています。

Perlコミュニティでも、毎年様々なアドベントカレンダーが開催されており、初心者向けのTipsから上級者向けの深い技術解説まで、多彩な記事が公開されてきました。日本では [Perl Advent Calendar](https://qiita.com/advent-calendar/2024/perl) が有名ですし、海外では [Perl Advent Calendar](https://perladvent.org/) が長年続いています。

## この企画の特徴 - AI技術の活用

今回の Perl Advent Calendar 2024 には、一つ大きな特徴があります。それは、**記事の執筆にAI技術を活用している**という点です。
...
私が所属する [Kansai.pm](http://kansai.pm.org/) は、関西地方を中心としたPerlコミュニティです。定期的に勉強会を開催し、技術情報の交換や親睦を深めています。
...
**関連リンク**
- [Perl公式サイト](https://www.perl.org/)
- [CPAN](https://metacpan.org/)
- [Perl Advent Calendar](https://qiita.com/advent-calendar/2024/perl)
- [Kansai.pm](http://kansai.pm.org/)
