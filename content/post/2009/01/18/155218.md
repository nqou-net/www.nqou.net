...
だが、それぞれ、
strawberry-perl-5.10.0.3.exe（[Strawberry Perl](http://strawberryperl.com/)）
openssl-0.9.8j.tar.gz（[OpenSSL: The Open Source toolkit for SSL/TLS](http://www.openssl.org/)）
で、問題なくインストールできた。
...
- dmake install
```</blockquote><div class="cite">[<cite>[README.Win32](http://cpansearch.perl.org/src/FLORA/Net-SSLeay-1.35/README.Win32)</cite>]</div>
