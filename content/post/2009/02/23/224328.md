...
色々と触発されてやってみた。
参考：
[Perl で XML の処理はどれが速いかベンチ : NDO::Weblog](http://naoya.dyndns.org/%7Enaoya/mt/archives/001209.html)
[iandeth. - XML::Simple は遅い説における意外な落とし穴](http://iandeth.dyndns.org/mt/ian/archives/000589.html)
[XML::Simple におけるパーサーの実行速度比較 - naoyaのはてなダイアリー](http://d.hatena.ne.jp/naoya/20050801/1122884138)
```text
...
```
読み込んだRSSファイルは、「[はてなブックマーク - タグ - 石原さとみ（タグ「石原さとみ」を含む新着エントリー）](http://b.hatena.ne.jp/search/tag?q=%E7%9F%B3%E5%8E%9F%E3%81%95%E3%81%A8%E3%81%BF&amp;users=1)」な感じの20件です。
