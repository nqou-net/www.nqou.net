...
<blockquote cite="http://blog.nqou.net/2006/09/21171132.html" title="ファイルのコピー＠のぶろぐ" class="blockquote">ファイルのコピーをする場合は、File::Copyというモジュールを使うのが良い。
...
参考：
[Daniel Muey / File-Copy-Recursive - search.cpan.org](http://search.cpan.org/dist/File-Copy-Recursive/)
