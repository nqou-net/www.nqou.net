...
description: Perlをツール的に使っていて、コードの中で複数の階層にあるファイルをディレクトリごと再帰的にコピーしたくなった
draft: false
image: /favicon.png
...
参考： [Daniel Muey / File-Copy-Recursive - search.cpan.org](http://search.cpan.org/dist/File-Copy-Recursive/)
