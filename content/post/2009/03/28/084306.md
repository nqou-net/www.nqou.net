...
description: 面白そうなスクリプトを見つけたので試してみた
draft: false
image: /favicon.png
...
---
面白そうなスクリプトを見つけたので試してみた。 [はてなブックマークのお気に入り候補を見つけるPerlスクリプト/楽](http://tech.bayashi.jp/archives/entry/perl/2009/002578.html) …が、途中でエラーになった。 
