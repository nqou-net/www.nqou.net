...
<div>[<cite>[Gitリポジトリ管理ツール「GitLab 5.2」リリース、フォーク機能などを追加 | SourceForge.JP Magazine](http://sourceforge.jp/magazine/13/05/23/180000)</cite>]</div>
...
これがあったので、[Alminium](http://alminium.github.io/alminium/)を止めてgitlabを使うようになりました。
...
丁度そのころ[Gitprep](https://github.com/yuki-kimoto/gitprep)を見つけたのでそれも考えました。

[インストールして試してみましたが](/2013/04/23/200400)、動作も軽快なので、Gitのリポジトリが欲しいならとても良い選択肢だと思います。
