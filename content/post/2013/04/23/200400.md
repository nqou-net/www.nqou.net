...
description: GitPrepというgithubのクローンを試してみました
draft: false
epoch: 1366715040
image: /favicon.png
...
\```default cpanm Mojolicious::Plugin::INIConfig
cpanm Mojolicious::Plugin::AutoRoute
cpanm DBIx::Connector
\```

`gitprep.conf`を開いて「Git command path」を適切に設定。
...
![GitPrepの画面](https://copy.com/vKms8VSdYoio3Zg9)
