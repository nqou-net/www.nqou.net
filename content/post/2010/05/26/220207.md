...
Accessorの比較は、[App::Benchmark::Accessors](http://search.cpan.org/dist/App-Benchmark-Accessors/lib/App/Benchmark/Accessors.pm)が有名ですよね。
...
アクセサをあらかじめ定義しておき、ベンチマークの中でnewしてsetしてgetしてsetする、という事をやりました。
まずは結果を。
...
上位3モジュールは僅差ですが、Class::Accessor::Liteが最も速かったです。
