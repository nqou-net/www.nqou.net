...
description: WWW::MechanizeとWeb::ScraperでLast
draft: false
epoch: 1283259014
image: /favicon.png
...
- [パスワード設定をコードに書かない(Config::Pit) - モダンなPerl入門 - モダンなPerl入門](http://perl-users.jp/modules/config_pit.html)
- [cho45 (さとう) / Config-Pit - search.cpan.org](http://search.cpan.org/dist/Config-Pit/)
- 適当なscriptでは use autodie; する - TokuLog 改メ tokuhirom’s blog
- [Paul Jamieson Fenwick / autodie - search.cpan.org](http://search.cpan.org/dist/autodie/)
