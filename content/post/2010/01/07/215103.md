...
description: "StrawberryPerlでminicpanを使う時に設定でハマったのでメモ"
draft: false
...
- [CPAN::Mini で CPAN のミラーをローカルに: blog.bulknews.net](http://blog.bulknews.net/mt/archives/002069.html)
- [use CPAN::Mini; - 今日のCPANモジュール](http://cpanmag.koneta.org/006-cpan-mini/)
