...
<div class="cite"> [<cite>[＠IT：Windows TIPS -- Tips：エラーを無視してファイルをコピーする方法―壊れかけたディスクからのファイルの救出―](http://www.atmarkit.co.jp/fwin2k/win2ktips/268filecopy/filecopy.html)</cite>] </div>
