...
[Make Link](https://addons.mozilla.org/ja/firefox/addon/make-link/)というアドオンです。
...
<div class="cite">[<cite>[Mozilla Japan - Firefox 用アドオン - 拡張機能 - ニュース＆ブログ](https://addons.mozilla.jp/firefox/extensions/news_and_blogs/)</cite>]</div>
...
<div class="cite">[<cite>[%title%](%url%)</cite>]</div>
```
