...
[mt-search.cgiとrobots.txt関係で調べていた](/2008/08/17/131943)中で、sitemapsに対する記事を幾つか見つけた。
...
<div class="cite">[<cite>[Googleなど3社、Sitemapsをサポート - サイト管理者は要注目 | エンタープライズ | マイコミジャーナル](http://news.mynavi.jp/news/2006/11/16/340.html)</cite>]</div>
...
<div class="cite">[<cite>[sitemaps.org - ホーム](http://www.sitemaps.org/ja/)</cite>]</div>
...
<div class="cite">[<cite>[sitemaps.org - プロトコル](http://www.sitemaps.org/ja/protocol.html)</cite>]</div>
...
<div class="cite">[<cite>[小粋空間: Sitemaps 0.90 用テンプレート（MT4対応）](http://www.koikikukan.com/archives/2007/10/31-011500.php)</cite>]</div>
...
とりあえず[小粋空間: Sitemaps 0.90 用テンプレート（MT4対応）](http://www.koikikukan.com/archives/2007/10/31-011500.php)のほうで作成してみました。
