...
MTOS4.2で[スタイルの変更がエラーになっていた件](/2008/08/19/011350)の続報。
...
<div class="cite">[<cite>[6A Plugins - MovableType | wiki.movabletype.org](https://github.com/movabletype/Documentation/wiki)</cite>]</div>
