...
```
Powered by MENTA <?= $MENTA::VERSION ?>
...
- <a name="menta.nanochat" href="<?= uri_for('nanochat/index') ?>">NANOChat</a>
...
<div class="nano">
ここの入退室管理を任されてる <strong class="name">なの</strong> なの。よろしくなの。
...
準備ができたら<a href="<?= uri_for('nanochat/enter') ?>">入口</a>で名前を教えてほしいの。
