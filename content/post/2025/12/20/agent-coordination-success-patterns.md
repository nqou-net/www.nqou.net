...
- prompt-engineering
- workflow
description: "GitHub Copilotのエージェント連携の成功パターンを実体験から解説。AGENTS.mdとカスタムエージェント作成の試行錯誤から見えた、名前の一致・定義場所・ワークフロー定義の3つのポイント。DeNA LLM勉強会の知見も活用した、初心者から中級者まで役立つ実践ガイド。"
---
