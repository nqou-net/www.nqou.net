---
date: 2025-12-25T23:45:00+09:00
...
iso8601: 2025-12-25T23:45:00+09:00
...
この記事は「**Perlで値オブジェクトを使ってテスト駆動開発してみよう**」シリーズの**第4回（全5回）**です。前回は、[Test2によるTDD実践とMethodName値オブジェクト](/2025/12/20/070000/)の実装を通じて、Red-Green-Refactorサイクルを体験しました。今回は、**複数の値オブジェクトを組み合わせた複合的な値オブジェクト**として、JSON-RPC 2.0のRequestとResponseを完全実装します。

> **シリーズナビゲーション**  
> ← 前回: [PerlのTest2でTDD実践 - 値オブジェクトのテスト戦略](/2025/12/20/070000/)  
