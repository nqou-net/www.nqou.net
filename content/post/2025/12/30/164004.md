...
{{< linkcard "/2025/12/30/164003/" >}}

今回は、処理を**ハンドラークラス**に分ける方法を学びます。
...
そこで、各機能を専用のクラスに切り出します。このようなクラスを**ハンドラークラス**と呼びます。
...
これが**責任の分離**です。BBSクラスは「どの処理を選ぶか」だけを担当し、「処理の中身」は各ハンドラークラスに任せます。
