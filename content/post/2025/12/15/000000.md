...
description: Perl の `List::Util` と `List::MoreUtils` を使ったリスト処理の便利な関数と使用例を紹介します。
draft: false
epoch: 1765724400
image: https://github.com/nqou-net/public_images/blob/main/images/2025/20251215000000-image.jpg?raw=true
iso8601: 2025-12-15T00:00:00+09:00
tags:
  - perl
  - list-util
  - list-moreutils
  - list-processing
title: 'List::Util と List::MoreUtils - リスト処理の強力なツール'
