...
epoch: 1764613730
hidden: false
image: /public_images/art-of-perl-one-liners-20251202032850.jpg
...
# Base64デコード
echo "SGVsbG8sIFBlcmwK" | perl -MMIME::Base64 -ne 'print decode_base64($_)'
...
```bash
# 以下のサンプルの実行には IO::Socket::SSL, Net::SSLeay も必要です。必要に応じてインストールしてください
# HTTPでコンテンツを取得
perl -MHTTP::Tiny -le 'print HTTP::Tiny->new->get("https://example.com")->{content}'
