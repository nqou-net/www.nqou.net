...
![Code Clinic Entrance with stacks of books](/public_images/2026/code-doctor-abstract-factory/scene-1.webp)
...
![Doctor pointing at the screen, diagnosing the code](/public_images/2026/code-doctor-abstract-factory/scene-2.webp)
...
![Doctor's note: Factory = Family](/public_images/2026/code-doctor-abstract-factory/scene-3.webp)
...
2. **ファミリーごとの具象クラスの実装** — `Report::Pdf::*` など、関連する製品群を実装
3. **Abstract Factory Roleの定義** — `Role::ReportFactory` で全部品の生成メソッドを要求
4. **Concrete Factoryの実装** — `ReportFactory::Pdf` などがファミリー単位で生成を保証
