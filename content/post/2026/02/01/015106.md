...
description: PerlでDiscord/Slack Botを作りながらCommand、Factory、Strategy、Observerパターンを実践で習得。全10章で実用レベルのBotフレームワークが完成します。
draft: false
epoch: 1769878266
image: /public_images/2026/hands-on-design-patterns-image.jpg
...
tags:
  ...
  - strategy-pattern
  - observer-pattern
title: Perlで執事Bot〜4つのデザインパターンで作るコマンド帝国
toc: true
---

![執事Bot - Butler Bot](/public_images/2026/hands-on-design-patterns/butler-bot-header.png)
...
![Commandパターン - コマンドカード](/public_images/2026/hands-on-design-patterns/command-pattern.png)
...
![Factoryパターン - コマンド工場](/public_images/2026/hands-on-design-patterns/factory-pattern.png)
...
![Strategyパターン - 性格スイッチ](/public_images/2026/hands-on-design-patterns/strategy-pattern.png)
...
![Observerパターン - 監視モニター](/public_images/2026/hands-on-design-patterns/observer-pattern.png)
