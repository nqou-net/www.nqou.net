...
{{< linkcard "/2026/moo-text-editor-06/" >}}
...
次回は、複数の操作を1つにまとめる**マクロ機能**（`MacroCommand`）を実装します。
