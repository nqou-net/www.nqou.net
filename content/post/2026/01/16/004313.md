...
「Perlでローグライク通知システムを作ろう」シリーズの最終回です。9回にわたって通知システムを作ってきましたが、実はこれ、Observerパターンというデザインパターンを実装していたのです。
...
Observerパターンは、GoF（Gang of Four）が1994年に発表した23のデザインパターンの1つです。
