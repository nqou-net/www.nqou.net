---
date: 2026-01-07T09:43:34+09:00
...
iso8601: 2026-01-07T09:43:34+09:00
tags:
  - perl
  - moo
  - design-patterns
...
- **[第1回](/2026/01/07/093522/)**: ハードコードされた設定値をMooのConfigクラスで管理する方法を学んだ
- **[第2回](/2026/01/07/093725/)**: 外部のINI形式の設定ファイルを読み込む `load_config` メソッドを追加した
- **[第3回](/2026/01/07/093928/)**: 複数の場所からConfigを使おうとしたら、それぞれで `new` したため設定が別々になる問題が発覚した
- **[第4回](/2026/01/07/094131/)**: クラス変数と `instance()` メソッドで単一インスタンスを保証する方法を実装した
