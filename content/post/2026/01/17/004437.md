...
title: '第6回-これがPrototypeパターンだ！ - PerlとMooでモンスター軍団を量産してみよう'
---
...
今回は、これまで作ってきたものが**Prototypeパターン**というデザインパターンであることを明かします。
...
実は、これらはすべて**Prototypeパターン**を学ぶための布石でした。

## Prototypeパターンとは

**Prototypeパターン**は、GoF（Gang of Four）デザインパターンの一つで、「**生成パターン**」に分類されます。
...
- **MooX::Clone**でMooクラスに`clone()`メソッドを追加できる
- `clone()`でオブジェクトを複製し、効率的に量産できる
- **浅いコピー**ではネストしたオブジェクトが共有される問題がある
