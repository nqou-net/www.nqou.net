---
date: 2026-01-09T00:43:12+09:00
description: エクスポーターを一元管理するクラスが欲しい。Contextパターンの考え方でDataExporterクラスを作成し、処理の委譲を学びます。
draft: false
epoch: 1767886992
image: /public_images/2026/strategy-pattern-series-structure-image.jpg
iso8601: 2026-01-09T00:43:12+09:00
tags:
  - perl
  - moo
  - design-patterns
...
今回作った`DataExporter`のようなクラスを、設計の用語でContext（コンテキスト）と呼ぶことがあります。
...
次回「[第6回-実行時に出力形式を切り替えよう](/2026/01/09/004515/)」では、実行時にエクスポーターを切り替える機能を追加します。お楽しみに！
