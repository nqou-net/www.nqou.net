...
iso8601: 2026-01-20T00:33:57+09:00
...
{{< linkcard url="https://www.nqou.net/2026/01/20/003340/" title="前回" >}}

今回は最終回として、アンカーID自動生成機能を追加し、Markdown目次ジェネレーターを完成させます。

## 今回のゴール

見出しテキストからアンカーID（`#introduction`、`#chapter-1`など）を自動生成し、リンク付きの目次を出力する機能を実装します。
...
{{< linkcard url="https://www.nqou.net/2026/01/20/003340/" title="前回" >}}
{{< linkcard url="https://www.nqou.net/2026/01/20/003414/" title="目次" >}}
