...
一方、lib::xiの方は、[生のファイル](https://raw.githubusercontent.com/gfx/p5-lib-xi/master/lib/lib/xi.pm)をそのまま使えば動きます。
[生のファイル](https://raw.githubusercontent.com/gfx/p5-lib-xi/master/lib/lib/xi.pm)を「xi.pm」という「名前を付けて保存」して、script.plと同じフォルダにある「lib」という名前のフォルダの中にコピーします。
