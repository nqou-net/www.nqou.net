...
```
 ...
 一方、lib::xiの方は、[生のファイル](https://raw.githubusercontent.com/gfx/p5-lib-xi/master/lib/lib/xi.pm)をそのまま使えば動きます。 [生のファイル](https://raw.githubusercontent.com/gfx/p5-lib-xi/master/lib/lib/xi.pm)を「xi.pm」という「名前を付けて保存」して、script.plと同じフォルダにある「lib」という名前のフォルダの中にコピーします。 
...
- [自動CPAN祭 AutoInstall.pm - 冬通りに消え行く制服ガールは、夢物語にリアルを求めない。 - subtech](http://subtech.g.hatena.ne.jp/cho45/20101129/1290963512)
- [lib::xi - installs missing libraries on demand - Islands in the byte stream](http://d.hatena.ne.jp/gfx/20110318/1300419163)
