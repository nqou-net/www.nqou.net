...
### 6.1 単一責任の原則（SRP: Single Responsibility Principle）

各ハンドラは**1つの責任だけ**を持つように設計します：
...
### 6.2 依存性注入（DI: Dependency Injection）
