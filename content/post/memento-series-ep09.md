...
{{< linkcard "https://www.nqou.net/content/post/memento-series-ep08.md" >}}
...
次回（最終回）は、作ってきたものが実は**Mementoパターン**だったことを明かし、デザインパターンの観点から総括します。
...
次回（最終回）は、作ってきたものが実は**Mementoパターン**というデザインパターンだったことを明かします。
