...
| **Strategyパターン** | `/content/post/2025/12/30/164012.md` | 第12回-デザインパターンの世界へ(Mooディスパッチャーシリーズ) | `/2026/01/03/001541/` | 高(生成パターンと振る舞いパターンの違い) |
| **Factory適用例** | `/content/post/2025/12/30/164009.md` | 第9回-自動で選ぶ仕組みを作ろう(Factoryパターン) | `/2026/01/03/001538/` | 極高(Factoryパターンの実装例) |
