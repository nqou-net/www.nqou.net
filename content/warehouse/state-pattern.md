...
1. **デザインパターン関連**
   ...
   - `/2026/01/03/001541/` - 第12回-これがデザインパターンだ！ - Mooを使ってディスパッチャーを作ってみよう
   - `/2026/01/03/001540/` - 第11回-完成！ディスパッチャー - Mooを使ってディスパッチャーを作ってみよう
...
1. **デザインパターン学習の導入**
   - [第12回-これがデザインパターンだ！](/2026/01/03/001541/) - Strategyパターンの解説（Stateパターンと比較）
   - [第11回-完成！ディスパッチャー](/2026/01/03/001540/) - ディスパッチャーの実装例
