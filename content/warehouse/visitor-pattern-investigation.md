...
|------------|----------------|-----------|--------|---------|
| `/content/post/2025/12/30/164012.md` | 第12回-これがデザインパターンだ！ - Mooを使ってディスパッチャーを作ってみよう | `/2026/01/03/001541/` | **高** | Strategyパターン（Visitorと同じく振る舞いパターン）、Moo使用、デザインパターン入門 |
| `/content/post/2025/12/30/164011.md` | 第11回-完成！ディスパッチャー - Mooを使ってディスパッチャーを作ってみよう | `/2026/01/03/001540/` | **高** | ディスパッチャー実装（Visitorと類似の構造）、Moo使用 |
...
1. **デザインパターン関連記事**（必須）
   - `/2026/01/03/001541/` - Strategyパターン解説（同じ振る舞いパターン）
...
**リンクテキスト例**:
```markdown
Visitorパターンは「振る舞いに関するパターン」の一つです。同じカテゴリーの[Strategyパターン](/2026/01/03/001541/)と比較すると理解が深まります。
