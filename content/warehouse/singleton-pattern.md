...
- **Mooを使ってディスパッチャーを作ってみよう** シリーズ
  - `/2026/01/03/001541/` - 第12回（Strategyパターン）
  - `/2026/01/03/001540/` - 第11回（完成！ディスパッチャー）
...
```markdown
Singletonパターンは[デザインパターン](/2026/01/03/001541/)の1つであり、
[Strategyパターン](/2026/01/03/001541/)とは異なる目的で使用されます。
