...
- 連載構造案は `agents/structure/<slug>-structure.md` に保存する（命名規則: スラッグ + "-structure.md"）
- フロントマター（YAML形式）をつける
- 調査結果の参照元を明記する（例: `調査結果: content/warehouse/<slug>-research.md に基づく`）
...
- 3つの構造案の骨格が明確に示されている
- 各案の特徴・メリット・デメリットが記載されている
- 連載構造表が全回分揃っている
- 1記事1概念の原則が守られている

### 第2版（SEO最適化版）での到達目標

- 各回のタイトルに主要キーワードが含まれている
- 推奨タグが英語小文字・ハイフン形式で統一されている
- メタ情報（description等）が最適化されている
- 検索意図に合致した構成になっている
