...
tools: ["codebase", "extensions", "fetch", "search/codebase", "githubRepo", "problems", "search", "searchResults", "usages", "vscodeAPI"]
---
...
- **Test Analysis**: Use `search/codebase` to understand testing patterns and coverage
