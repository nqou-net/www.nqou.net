...
tools: ['changes', 'codebase', 'edit', 'fetch', 'githubRepo', 'openSimpleBrowser', 'search', 'searchResults', 'usages', 'websearch', 'view', 'create']
...
**必ず守ること：**
- フロントマターは YAML（`---`）形式で記述
- `date` や `iso8601` フィールドは含めない（自動生成される）
